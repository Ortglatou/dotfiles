...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- launch emoji picker
    , ((modm .|. shiftMask, xK_p     ), spawn emojiPicker)
    
    -- screenshot full screen
    , ((0,                  xK_Print ), spawn screenshotFull)

    -- screenshot selection of screen
    ...
    -- close focused window
    , ((modm .|. shiftMask, xK_x     ), spawn xkiller)
...
--
main = do
        xmproc <- spawnPipe "xmobar -x 0 ~/.config/xmobar/xmonad.bar"
...
help = unlines ["The default modifier key is 'alt'. Default keybindings:",
    ...
    "mod-Shift-p      Launch emoji picker",
    "mod-Shift-p      Launch gmrun",
    "mod-Shift-c      Close/kill the focused window",
    "mod-Shift-c      Close/kill the clicked window",
